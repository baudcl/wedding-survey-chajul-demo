...
const themeConfig = {
    ...
    colors: {
        primary: '#8DB1A8',      // Vert sage - couleur principale
        secondary: '#EFA8B4',    // Rose poudré - couleur secondaire
        accent: '#EB964D',       // Orange doux - couleur d'accent
        background: '#FFF8F1',   // Blanc crème - fond principal
        backgroundAlt: '#FDEEE4', // Pêche clair - fond alternatif
